...
public class PrintUtil {
	...
	public static void testCasePassedWithScreenshot(WebDriver webdriver, String msg) {
		...
		if (null != ExtentTestManager.getTest()) {
			ExtentTestManager.getTest().log(LogStatus.INFO, "TS_PASS", font_green(msg)
					+ ExtentTestManager.getTest().addBase64ScreenShot(ScreenShot.takeScreenshot(webdriver)));
		}
	...
	public static void testCaseFailedWithScreenshot(String msg, WebDriver webdriver) {
		...
		if (null != ExtentTestManager.getTest()) {
			ExtentTestManager.getTest().log(LogStatus.FAIL, "TS_FAIL", font_red(msg)
					+ ExtentTestManager.getTest().addBase64ScreenShot(ScreenShot.takeScreenshot(webdriver)));
		}
